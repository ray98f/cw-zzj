...
(function($) {
  ...
  $.parser = {
    ...
    plugins : [ "draggable", "droppable", "resizable", "pagination", "tooltip",
        ...
        "tree", "combobox", "combotree", "combogrid", "numberbox",
        "validatebox", "searchbox", "numberspinner", "timespinner", "calendar",
    ...
    parse : function(_2) {
      ...
      $
          .each(
              ...
              function(i, v) {
                var per = new RegExp("width:\\s*(\\d{1,3})%(-\\d{1,4})?")
                    .exec($(v).attr('style'));
                if (per && per.length > 1) {
                  var per1 = per[1];
                  var per2 = 0;
                  if (per.length > 2 && typeof per[2] != 'undefined')
                    per2 = per[2];
                  ...
                  $(v).attr(
                      "data-options",
                      "width:" + ($(v.parentNode).width() * per1 / 100 + per2)
                          + "," + $(v).attr("data-options"));
                }
              });
          ...
          if (typeof pp == "string") {
            ...
            for ( var _a in pp) {
              ...
              if (_b == "boolean") {
                ...
                if (_b == "number") {
                  _9[_a] = t.attr(_a) == "0" ? 0 : parseFloat(t.attr(_a))
                      || undefined;
                }
              }
            }
...
(function($) {
    ...
    function _33() {
      ...
      _30.droppables.each(function() {
        ...
        if (e.pageX > p2.left && e.pageX < p2.left + _37.outerWidth()
            && e.pageY > p2.top && e.pageY < p2.top + _37.outerHeight()) {
          if (_32.revert) {
            $(e.data.target).css({
              position : e.data.startPosition,
              left : e.data.startLeft,
  ...
  $.fn.draggable = function(_38, _39) {
    ...
    return this.each(function() {
      ...
      var _3c = _3a.handle ? (typeof _3a.handle == "string" ? $(_3a.handle,
          this) : _3a.handle) : $(this);
      $.data(this, "draggable", {
        options : _3a,
        handle : _3c
      });
...
(function($) {
    ...
    if (_71.text) {
      ...
      if (_71.iconCls) {
        t.find(".l-btn-text").addClass(_71.iconCls).addClass(
            _71.iconAlign == "left" ? "l-btn-icon-left" : "l-btn-icon-right");
      }
    } else {
  ...
  function _72(_74, _75) {
    ...
    if (_75) {
      ...
      $(_74).addClass(
          _76.plain ? "l-btn-selected l-btn-plain-selected" : "l-btn-selected");
      _76.selected = true;
    } else {
      if (!_76.group) {
                ...
                if (_87 == "last") {
                  ...
                  if (_87 == "manual") {
                    $("<span style=\"padding-left:6px;\"></span>").html(
                        _83.beforePageText).appendTo(tr).wrap("<td></td>");
                    bb.num = $(
...
(function($) {
  ...
  function _109(_10a, ul, _10b) {
    ...
    var _10f = $(ul).children("li:last").children("div.tree-node").addClass(
        "tree-node-last");
  ...
  function _16a(_16b, _16c) {
    ...
    _16e.width(_16d + 20);
    _16e
        .height(document.compatMode == "CSS1Compat" ? (18 - (_16e.outerHeight() - _16e
            .height()))
            : 18);
...
(function($) {
  ...
  function _1fe(_1ff) {
    $(_1ff).find("div.panel:visible,div.accordion:visible,div.tabs-container:visible,div.layout:visible")
        .each(function() {
  ...
  $.fn.panel.parseOptions = function(_231) {
    ...
    return $.extend({}, $.parser.parseOptions(_231, [ "id", "width",
      "height", "left", "top", "title", "iconCls", "cls", "headerCls", "bodyCls", 
      "tools", "href", "method", {
      cache : "boolean",
      fit : "boolean",
      border : "boolean",
...
(function($) {
  ...
  function _246(_247) {
    ...
    _248.window.resizable({
      ...
      onStartResize : function(e) {
        _248.pmask = $("<div class=\"window-proxy-mask\"></div>").insertAfter(
            _248.window);
        _248.pmask.css({
          zIndex : $.fn.window.defaults.zIndex++,
          left : e.data.left,
        ...
        if (!_248.proxy) {
          _248.proxy = $("<div class=\"window-proxy\"></div>").insertAfter(
              _248.window);
        }
        _248.proxy.css({
          zIndex : $.fn.window.defaults.zIndex++,
  ...
  $.fn.window.parseOptions = function(_251) {
    return $.extend({}, $.fn.panel.parseOptions(_251), $.parser.parseOptions(
        _251, [ {
          draggable : "boolean",
          resizable : "boolean",
          shadow : "boolean",
...
(function($) {
          ...
          onResize : function(_25d, _25e) {
            ...
            _257.panel("resize", {
              ...
              height : (_25e == "auto") ? "auto" : _25f.height()
                  - _25f.children("div.dialog-toolbar")._outerHeight()
  ...
  $.fn.dialog.parseOptions = function(_26a) {
    return $.extend({}, $.fn.window.parseOptions(_26a), $.parser.parseOptions(
        _26a, [ "toolbar", "buttons" ]));
  };
    ...
    if (_274) {
      ...
      for ( var _275 in _274) {
        $("<a></a>").attr("href", "javascript:void(0)").text(_275).css(
            "margin-left", 10).bind("click", eval(_274[_275])).appendTo(tb)
            .linkbutton();
      }
    }
    win.window({
  ...
  function _2a5(_2a6, pp, _2a7) {
    ...
    pp.panel($.extend({}, {
      ...
      onExpand : function() {
        ...
        opts.onSelect.call(_2a6, $(this).panel("options").title, _299(_2a6,
            this));
      },
      onBeforeCollapse : function() {
      ...
      onCollapse : function() {
        ...
        opts.onUnselect.call(_2a6, $(this).panel("options").title, _299(_2a6,
            this));
      }
    }));
...
(function($) {
    ...
    $(_2f8).children("div.tabs-header").unbind().bind("click", function(e) {
      if ($(e.target).hasClass("tabs-scroller-left")) {
        ...
        function(e) {
          ...
          if (li.length) {
            opts.onContextMenu.call(_2f8, e, li.find("span.tabs-title").html(),
                _2fa(li));
          }
        });
    function _2fa(li) {
  ...
  function _30a(_30b, _30c) {
    ...
    _2e6(_30b);
    $.data(_30b, "tabs").options.onUpdate
        .call(_30b, opts.title, _312(_30b, pp));
  }
  ;
...
(function($) {
  ...
  function _363(_364, _365, el) {
    ...
    var _367 = $.extend({}, $.fn.layout.paneldefaults, {
      ...
      onOpen : function() {
        ...
        if (!t.length) {
          t = $("<a href=\"javascript:void(0)\"></a>").addClass(_369).appendTo(
              tool);
          t.bind("click", {
            dir : dir
          }, function(e) {
      ...
      _36a.resizable($.extend({},
          {
            ...
            onStartResize : function(e) {
              ...
              if (dir == "north") {
                pos.top = parseInt(_36a.css("top")) + _36a.outerHeight()
                    - _36c.height();
            ...
            onResize : function(e) {
              if (dir == "north" || dir == "south") {
                ...
                _36f.css("top", e.pageY - $(_364).offset().top - _36f.height()
                    / 2);
              } else {
                var _36f = $(">div.layout-split-proxy-h", _364);
                _36f.css("left", e.pageX - $(_364).offset().left - _36f.width()
                    / 2);
              }
              return false;
            },
      ...
      if (_377 == "east") {
        ...
        if (_377 == "west") {
          ...
          if (_377 == "north") {
            ...
            _379.east.add(_379.west).add(_379.expandEast).add(_379.expandWest)
                .panel("resize", {
                  top : 28 - 1,
                  height : hh
                });
  ...
  $.fn.layout.parsePanelOptions = function(_396) {
    var t = $(_396);
    return $.extend({}, $.fn.panel.parseOptions(_396), $.parser.parseOptions(
        _396, [ "region", {
          split : "boolean",
          minWidth : "number",
          minHeight : "number",
...
(function($) {
    ...
    function _39b(menu) {
      ...
      if (menu.hasClass("menu-content")) {
        ...
        menu.children("div").each(
            function() {
              var item = $(this);
              var _39f = $.extend({}, $.parser.parseOptions(this, [ "name",
                  "iconCls", "href", {
                    separator : "boolean"
                  } ]), {
              ...
              if (!item.hasClass("menu-sep")) {
                ...
                if (_39f.iconCls) {
                  $("<div class=\"menu-icon\"></div>").addClass(_39f.iconCls)
                      .appendTo(item);
                }
                if (_39f.disabled) {
  ...
  function _3a2(_3a4, menu) {
    ...
    _3a6 += 65;
    menu._outerWidth(Math
        .max((menu[0].originalWidth || 0), _3a6, opts.minWidth));
  ...
  $.fn.menu.methods = {
    ...
    setIcon : function(jq, _3ca) {
      return jq.each(function() {
        ...
        if (item.iconCls) {
          $(item.target).children("div.menu-icon").removeClass(item.iconCls)
              .addClass(_3ca.iconCls);
        } else {
          $("<div class=\"menu-icon\"></div>").addClass(_3ca.iconCls).appendTo(
              _3ca.target);
        }
      });
    },
...
(function($) {
  function init(_3ec) {
    ...
    var _3ed = $("<input type=\"text\" class=\"searchbox-text\">").appendTo(
        span);
  ...
  $.fn.searchbox.methods = {
    ...
    selectName : function(jq, name) {
      return jq.each(function() {
        ...
        if (menu) {
          menu.children("div.menu-item[name=\"" + name + "\"]").triggerHandler(
              "click");
        }
      });
    },
...
(function($) {
  function _431(_432, _433) {
    ...
    var _436 = $("<iframe id=" + _435 + " name=" + _435 + "></iframe>").attr(
        "src", window.ActiveXObject ? "javascript:false" : "about:blank").css({
      position : "absolute",
      top : -1000,
      left : -1000
    });
    ...
    try {
      ...
      _436.bind("load", cb);
      for ( var n in _434) {
        var f = $("<input type=\"hidden\" name=\"" + n + "\">").val(_434[n])
            .appendTo(form);
        _437 = _437.add(f);
      }
      _438();
  ...
  function _448(_449) {
    ...
    var _44a = [ "combo", "combobox", "combotree", "combogrid", "datebox",
        "datetimebox", "spinner", "timespinner", "numberbox", "numberspinner",
        "slider" ];
...
(function($) {
  ...
  $.fn.numberbox.parseOptions = function(_470) {
    ...
    return $.extend({}, $.fn.validatebox.parseOptions(_470), $.parser
        .parseOptions(_470, [ "decimalSeparator", "groupSeparator", "suffix", {
          min : "number",
          max : "number",
          precision : "number"
        } ]), {
  ...
  function _47e(_47f) {
    ...
    if ($(_47f).find(".calendar-menu-month-inner").is(":empty")) {
      ...
      for (var i = 0; i < 3; i++) {
        ...
        for (var j = 0; j < 4; j++) {
          $("<td class=\"calendar-menu-month\"></td>").html(opts.months[idx++])
...
(function($) {
  ...
  $.fn.timespinner.parseOptions = function(_4d3) {
    return $.extend({}, $.fn.spinner.parseOptions(_4d3), $.parser.parseOptions(
        _4d3, [ "separator", {
          showSeconds : "boolean",
          highlight : "number"
        } ]));
...
(function($) {
  ...
  function _4ea(_4eb) {
    ...
    _4ee.children("div.datagrid-header,div.datagrid-body,div.datagrid-footer")
        .width(_4ee.width());
    _4ef.children("div.datagrid-header,div.datagrid-body,div.datagrid-footer")
        .width(_4ef.width());
    var hh;
    _4f0.css("height", "");
    _4f1.css("height", "");
    ...
    if (opts.height != "auto") {
      var _4f5 = _4ed - _4ef.children("div.datagrid-header")._outerHeight()
  ...
  function _504(_505, _506) {
    ...
    function _508(_509) {
      ...
      (_509 ? dc.body1 : dc.body2).children("table.datagrid-btable-frozen")
          .append(tr);
    }
    ;
  }
      ...
      function _559(type) {
        ...
        if (type == "header") {
          ...
          opts.finder.getTr(_551, 0, type).find(
              "td[field=\"" + _556 + "\"] div.datagrid-cell").each(function() {
            var w = _55b($(this));
            if (_55a < w) {
              _55a = w;
            }
  ...
  function _513(_55c, _55d) {
    ...
    function fix(_561) {
      ...
      if (!col.checkbox) {
        _55e.ss.set("." + col.cellClass, col.boxWidth ? col.boxWidth + "px"
            : "auto");
      }
    }
    ;
  ...
  $.fn.datagrid = function(_614, _615) {
    //防止增删记录时datagrid不自动调整大小
    /*if (!_614.fit) {
      var onLoadSuccess = _614.onLoadSuccess;
      _614.onLoadSuccess = function(data) {
    ...
    if (!_614.fit) {
      var onLoadSuccess = _614.onLoadSuccess;
      _614.onLoadSuccess = function(data) {
        this.onLoadSuccess1 = onLoadSuccess;
        $(this).datagrid("resize");
        if($.isFunction(onLoadSuccess))
          this.onLoadSuccess1(data);
      }
    }
  ...
  $.fn.datagrid.parseOptions = function(_685) {
    var t = $(_685);
    return $
        .extend({}, $.fn.panel.parseOptions(_685), $.parser.parseOptions(_685,
  ...
  var _688 = {
    render : function(_689, _68a, _68b) {
      ...
      for (var i = 0; i < rows.length; i++) {
        ...
        var cls = "class=\"datagrid-row "
            + (i % 2 && opts.striped ? "datagrid-row-alt " : " ") + _68f + "\"";
    ...
    renderRow : function(_698, _699, _69a, _69b, _69c) {
      ...
      for (var i = 0; i < _699.length; i++) {
        ...
        if (col) {
          ...
          cc.push(">");
          if (col.checkbox) {
            cc.push("<input type=\"checkbox\" name=\"" + _69e + "\" value=\""
                + (_69f != undefined ? _69f : "") + "\">");
          } else {
            if (col.formatter) {
    ...
    updateRow : function(_6a5, _6a6, row) {
      ...
      var _6a7 = "datagrid-row "
          + (_6a6 % 2 && opts.striped ? "datagrid-row-alt " : " ") + _6a7;
      function _6a9(_6aa) {
        var _6ab = $(_6a5).datagrid("getColumnFields", _6aa);
        var tr = opts.finder.getTr(_6a5, _6a6, "body", (_6aa ? 1 : 2));
        var _6ac = tr.find("div.datagrid-cell-check input[type=checkbox]").is(
            ":checked");
    ...
    insertRow : function(_6ad, _6ae, row) {
      ...
      function _6b4(_6b5) {
        ...
        var tr = "<tr id=\"" + _6b8
            + "\" class=\"datagrid-row\" datagrid-row-index=\"" + _6ae
            + "\"></tr>";
        if (_6ae >= data.rows.length) {
          if (data.rows.length) {
    ...
    onAfterRender : function(_6c1) {
      ...
      if (opts.showFooter) {
        ...
        _6c2.find("div.datagrid-cell-rownumber,div.datagrid-cell-check").css(
            "visibility", "hidden");
      }
    }
  };
          ...
          if (type == "body") {
            ...
            if (!tr.length) {
              tr = (_6ca == 1 ? dc.body1 : dc.body2)
                  .find(">table>tbody>tr[datagrid-row-index=" + _6c9 + "]");
            }
            return tr;
          } else {
            if (type == "footer") {
          ...
          $.fn.datagrid.defaults.view,
          {
            ...
            renderGroup : function(_701, _702, _703, _704) {
              ...
              if (!_704) {
                ...
                _707
                    .push(opts.groupFormatter.call(_701, _703.value, _703.rows));
                _707.push("</span>");
              }
              _707.push("</td>");
              _707.push("</tr>");
            ...
            bindEvents : function(_70d) {
              ...
              var _70f = ($.data(body[0], "events") || $._data(body[0],
              ...
              body.unbind("click").bind(
                  ...
                  function(e) {
                    ...
                    if (_710.length) {
                      var _711 = _710.closest("div.datagrid-group").attr(
                          "group-index");
...
(function($) {
  ...
  function _747(_748) {
    ...
    dc.body1.add(dc.body2).bind(
        ...
        function(e) {
          ...
          if (tt.hasClass("tree-hit")) {
            tt.hasClass("tree-expanded") ? tt.addClass("tree-expanded-hover")
                : tt.addClass("tree-collapsed-hover");
          }
          e.stopPropagation();
        }).bind(
  ...
  function _774(_775) {
    ...
    _776.find("div.datagrid-view2 div.datagrid-body tr.datagrid-row-selected")
        .each(function() {
                  ...
                  if (row.children && row.children.length) {
                    ...
                    _7bc
                        .push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan="
                            + (_7b4.length + (opts.rownumbers ? 1 : 0))
                            + "><div style=\"display:" + v + "\">");
                    _7bc = _7bc.concat(tt);
                    _7bc.push("</div></td></tr>");
                  }
    ...
    finder : {
      getTr : function(_7eb, id, type, _7ec) {
        ...
        if (_7ec == 0) {
          ...
          if (type == "body") {
            var tr = $("#" + $.data(_7eb, "datagrid").rowIdPrefix + "-" + _7ec
                + "-" + id);
            if (!tr.length) {
...
(function($) {
  function _7f2(_7f3, _7f4) {
    ...
    if ($(_7f3).css('width') != ''
        && $(_7f3).css('width').indexOf('%') == $(_7f3).css('width').length - 1) {
      alert($(_7f3).html());
    }
    _7f6.appendTo("body");
  ...
  function _834(_835, _836) {
    ...
    for (var i = 0; i < _836.length; i++) {
      var _839 = $("<input type=\"hidden\" class=\"combo-value\">").appendTo(
          _838);
      if (name) {
        _839.attr("name", name);
      }
...
(function($) {
    ...
    if (row) {
      ...
      if (item.position().top <= 0) {
        ...
        if (item.position().top + item.outerHeight() > _859.height()) {
          var h = _859.scrollTop() + item.position().top + item.outerHeight()
              - _859.height();
          _859.scrollTop(h);
        }
      }
  ...
  function _862(_868, _869, _86a) {
    ...
    for (var i = 0; i < _869.length; i++) {
      ...
      if (row) {
        ...
        //setValue setValues方法同步checkbox状态
        $("#" + row.domId).find('input.combobox-checkbox')._propAttr('checked',
            true);
      }
      vv.push(v);
      ss.push(s);
  ...
  function _881(_882) {
    ...
    $(_882).combo(
        $.extend({}, opts, {
          onShowPanel : function() {
            $(_882).combo("panel").find("div.combobox-item,div.combobox-group")
                .show();
    ...
    $(_882).combo('textbox').bind(
        'blur',
        function() {
          setTimeout(function(){
            if (isfromclick && $(_882).combo('panel').is(":visible")) {
              isfromclick = false;
              return;
            }
            var opts = $(_882).combobox('options');
            var value = opts.valueField;
            var name = opts.textField;
            var flag = true;
            var datas = $(_882).combobox('getData');
            var i, j, k;
            if (opts.multiple) {
              var tvs = $(_882).combobox('getValues');
              var tts = $(_882).combobox('getText');
              if (!tts)
                return;
              var ttsarr = tts.split(',');
              var tmp = {};
              ...
              var tv = $(_882).combobox("getValue");
              var tt = $(_882).combobox('getText');
              if (!tt)
                return;
              for (i = 0; i < datas.length; i++) {
                v = datas[i];
                if ((!tv) || (tv == v[value] && tt == v[name])) {
                  flag = false;
                  break;
                }
              }
            ...
            if (flag) {
              $(_882).combobox('clear');
              $($(_882).combobox('panel')).find('input.combobox-checkbox')._propAttr('checked', false);
              $.messager.alert('提示', '请选择下拉列表项！');
            }
          },300);
        });
  }
  ...
  $.fn.combobox.parseOptions = function(_88e) {
    var t = $(_88e);
    return $.extend({}, $.fn.combo.parseOptions(_88e), $.parser.parseOptions(
        _88e, [ "valueField", "textField", "groupField", "mode", "method",
            "url" ]));
  };
  ...
  function findRowBy(target, value, param, isGroup) {
    ...
    if (isGroup) {
      ...
      return _findRow(state.data, (param ? param : state.options.valueField),
          value);
    }
  ...
  $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
    ...
    finder : {
      getEl : function(target, value) {
        if (!value || !$.trim(value))
          return null;
        var r = findRowBy(target, value);
        if(r != null)return $('#' + r.domId);
      },
      getRow : function(target, p) {
        var state = $.data(target, 'combobox');
        var index = (p instanceof jQuery) ? p.attr('id').substr(
            state.itemIdPrefix.length + 1) : getRowIndex(target, p);
...
(function($) {
    ...
    function _8d9() {
      ...
      for (var i = 0; i < opts.buttons.length; i++) {
        ...
        var t = $("<a href=\"javascript:void(0)\"></a>").html(
            $.isFunction(btn.text) ? btn.text(_8d6) : btn.text).appendTo(td);
        t.bind("click", {
          target : _8d6,
          handler : btn.handler
        }, function(e) {
  ...
  $.fn.datebox.parseOptions = function(_8ee) {
    return $.extend({}, $.fn.combo.parseOptions(_8ee), $.parser.parseOptions(
        _8ee, [ "sharedCalendar" ]));
  };
...
(function($) {
  ...
  function _8f8(_8ff, _900, _901) {
    ...
    function _902(date) {
      ...
      return tt
          .join($(_8ff).datetimebox("spinner").timespinner("options").separator);
    }
    ;
  }
  ;
  ...
  $.fn.datetimebox.parseOptions = function(_90b) {
    var t = $(_90b);
    return $.extend({}, $.fn.datebox.parseOptions(_90b), $.parser.parseOptions(
        _90b, [ "timeSeparator", {
          showSeconds : "boolean"
        } ]));
  };
...
(function($) {
  ...
  function _927(_928) {
    ...
    _92a.find("div.slider-inner").unbind(".slider").bind(
        ...
        function(e) {
          ...
          var pos = $(this).offset();
          var _92f = _93e(_928, (opts.mode == "h" ? (e.pageX - pos.left)
              : (e.pageY - pos.top)));
          _92d(_92f);
          opts.onComplete.call(_928, opts.value);
        });
  ...
  function _931(_932, _933) {
    ...
    if (opts.mode == "h") {
      ...
      var _938 = "top:" + pos + "px;";
      _935.find(".slider-handle").attr("style", _938);
      tip.attr("style", _938 + "margin-left:" + (-Math.round(tip.outerWidth()))
          + "px");
    }
    if (_936 != _933) {
