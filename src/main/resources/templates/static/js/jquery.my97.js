...
(function ($) {
    ...
    function bindEvents(target) {
        ...
        if (!opts.disabled) {
            input.bind("click.my97", function (e) {
                //TODO 触发my97
                WdatePicker(opts);//添加多一次是为了解决，某些情况下，点击一下不出面my97插件
                WdatePicker(opts);
            });
            arrow.bind("click.my97",function () {
                //TODO 触发my97
                WdatePicker($.extend({}, opts, {el:opts.id}));//添加多一次是为了解决，某些情况下，点击一下不出面my97插件
    ...
    function _5f(_60) {
      var _61 = $.data(_60, "my97").options;
      var fn = _61.onChange;
      _61.onChange = function() {
      };
      setValue(_60, _61.value);
