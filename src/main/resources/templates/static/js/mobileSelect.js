		...
		init: function(config){
		    ...
		    _this.ensureBtn.addEventListener('click',function(){
		    	...
		    	if(_this.triggerDisplayData){
		    		tempValue =  (tempValue.substring(tempValue.length - 1) == ':') ? tempValue.substring(0, tempValue.length - 1) : tempValue;
		    		console.log( _this.trigger.tagName)
